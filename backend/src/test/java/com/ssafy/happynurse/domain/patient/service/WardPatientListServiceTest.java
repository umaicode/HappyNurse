...
class WardPatientListServiceTest {
    ...
    @Test
    @DisplayName("listWardPatients - DB 본인 담당 기준으로 isMyPatient 매핑")
    void listWardPatients_본인담당_기준_매핑() {
        Long wardId = 3L;
        Long me = 99L;
    ...
    @Test
    @DisplayName("listWardPatients - 빈 결과면 카운트/담당 조회 없이 빈 리스트")
    ...
    @Test
    @DisplayName("listWardPatients - DB 본인 담당이 비어있으면 모든 환자 isMyPatient false")
    void listWardPatients_본인담당_없으면_모두_false() {
        Long wardId = 3L;
        Long me = 99L;
        Encounter e1 = createEncounter(100L, "김가민", Gender.female,
                LocalDate.of(1999, 5, 20), "7101호", "A");
